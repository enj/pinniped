...
func (c *FakeWhoAmIRequests) Get(name string, options v1.GetOptions) (result *v1alpha1.WhoAmIRequest, err error) {
	obj, err := c.Fake.
...
func (c *FakeWhoAmIRequests) List(opts v1.ListOptions) (result *v1alpha1.WhoAmIRequestList, err error) {
	obj, err := c.Fake.
...
func (c *FakeWhoAmIRequests) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeWhoAmIRequests) Update(whoAmIRequest *v1alpha1.WhoAmIRequest) (result *v1alpha1.WhoAmIRequest, err error) {
	obj, err := c.Fake.
...
func (c *FakeWhoAmIRequests) UpdateStatus(whoAmIRequest *v1alpha1.WhoAmIRequest) (*v1alpha1.WhoAmIRequest, error) {
	obj, err := c.Fake.
...
func (c *FakeWhoAmIRequests) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeWhoAmIRequests) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(whoamirequestsResource, listOptions)
...
func (c *FakeWhoAmIRequests) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.WhoAmIRequest, err error) {
	obj, err := c.Fake.
